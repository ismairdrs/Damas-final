 ...
 * @author Junior
 */
public class SelecionarModo extends JFrame implements ActionListener{
	...
	public void iniciar() {
		...
		botao1= new JButton("Trocar Modo");
	...
	public SelecionarModo(JogoDeDamas jogoDeDamas,Tabuleiro jogo) {
		iniciar();
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == botao1) {
			if(combo1.getSelectedIndex() == 0 || combo2.getSelectedIndex() == 0) {
				JOptionPane.showMessageDialog(jogoDeDamas,"Os campos não podem ficar vazios");
			}else {
